...
(function () {
  ...
  ToasterBox.prototype.openToaster = function () {
    // build out toaster
    buildToaster.call(this); // Initialize Event Listeners
  ...
  ToasterBox.prototype.closeToaster = function () {
    ...
    if (_.toasterContainer.classList.contains('top-left') || _.toasterContainer.classList.contains('top-center') || _.toasterContainer.classList.contains('top-right')) {
      _.toasterContainer.style.webkitAnimation = "fadeoutTop .5s";
      _.toasterContainer.style.animation = "fadeoutTop .5s";
    }

    if (_.toasterContainer.classList.contains('bottom-left') || _.toasterContainer.classList.contains('bottom-center') || _.toasterContainer.classList.contains('bottom-right')) {
  ...
  function buildToaster() {
    ...
    this.toasterContainer.append(toasterMsg); // close button
    ...
    docFrag.append(this.toasterContainer); // append Doc Fragment to body
