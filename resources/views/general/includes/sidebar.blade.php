        ...
        <div class="scrollbar-inner">
          ...
          <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
              ...
              <ul class="navbar-nav">
                <li class="nav-item">
                <a class="nav-link {{ isset($active) === 'dashboard' ? 'active' : '' }}" href="{{ route('client.index') }}">
                    <i class="ni ni-align-left-2 text-primary"></i>
                    <span class="nav-link-text">Dashboard</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link {{ isset($active) === 'presentations' ? 'active' : '' }}" href="{{ route('client.presentation') }}">
                      <i class="ni ni-single-copy-04 text-orange"></i>
                      <span class="nav-link-text">My Presentations</span>
                    </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link {{ isset($active) === 'meeting_minutes' ? 'active' : '' }}" href="{{ route('client.meeting_minutes') }}">
                      <i class="ni ni-single-copy-04 text-orange"></i>
                      <span class="nav-link-text">My Metting Minutes</span>
                    </a>
                </li>
                <li class="nav-item">
                <a class="nav-link {{ isset($active) === 'documents' ? 'active' : '' }}" href="{{ route('client.documents') }}">
                    <i class="ni ni-single-copy-04 text-orange"></i>
